...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Tác tử \textit{Hiệu chỉnh}:} Dựa trên phản hồi từ Tác tử Học sinh, tác tử này tiến hành sửa đổi, tinh chỉnh ngôn từ và logic để câu hỏi đạt chuẩn sư phạm cao nhất.
    \end{itemize}
\end{enumerate}
...
Báo cáo sẽ trình bày một cách có hệ thống về giải pháp đề xuất, quy trình đánh giá, kết quả và xây dựng ứng dụng Web Openlet nhằm hiện thực hóa nghiên cứu. Toàn bộ nội dung khóa luận được chia thành 7 chương với bố cục như sau:
