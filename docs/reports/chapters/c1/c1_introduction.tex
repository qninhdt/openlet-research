...
nhận dạng ký tự quang học (OCR) truyền thống như
Tesseract. Tuy nhiên, các công cụ này thường gặp khó khăn
khi xử lý các tài liệu có cấu trúc phức tạp hoặc chất lượng ảnh thấp. Sự xuất
hiện của các mô hình thị giác - ngôn ngữ (VLM) như GPT-4o hay Gemini Pro đã mở
...
- \textbf{Đánh giá thực nghiệm}: So sánh hiệu năng của các mô hình sLLM mã nguồn
...
- \textbf{Giải quyết bài toán kỹ thuật}: Xây dựng chiến lược lời nhắc và định dạng
