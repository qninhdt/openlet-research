...
Như trong Hình~\ref{fig:multiagent-architecture}, hệ thống tác tử hoạt động theo hai vòng lặp kiểm soát chất lượng. Hai vòng lặp này được sắp xếp tuần tự và chuyên biệt cho một phần của câu hỏi: Vòng thứ nhất sẽ cải thiện chất lượng phần thân câu hỏi và Vòng lặp 2 sẽ tập trung cải thiện chất lượng đáp án nhiễu.
...
Bên cạnh đó, một kỹ thuật quan trọng được sử dụng trong tác tử \textit{Sinh câu hỏi} là cơ chế học từ các mẫu tham chiếu. Cụ thể, trước khi sinh câu hỏi kể từ vòng lặp thứ hai, tác tử sẽ nhận được hai tập các câu hỏi:
\begin{itemize}
...
Một quyết định thiết kế cốt lõi là việc tác tử \textit{Học sinh} được yêu cầu giải bài kiểm tra theo định dạng trắc nghiệm nhiều lựa chọn đúng (Select All That Apply - SATA). Các nghiên cứu đánh giá đã chỉ ra rằng khi yêu cầu LLM giải một câu hỏi trắc nghiệm một đáp án đúng đơn thuần, mô hình thường sẽ tìm cách loại trừ và chọn ra đáp án có vẻ hợp lý nhất thay vì thực sự hiểu nội dung của các lựa chọn \cite{xu2025satabench}. Bằng cách ``đánh lừa'' LLM rằng bài kiểm tra yêu cầu lựa chọn các đáp án đúng, mô hình bị ép buộc phải thẩm định từng phương án một cách độc lập so với các phương án còn lại. Nhờ cơ chế khắt khe này, hệ thống có thể vô hiệu hóa khả năng suy luận đoán mò của tác tử, từ đó giúp phát hiện ra các câu hỏi có các lựa chọn mơ hồ, không chính xác. Nếu tác tử \textit{Học sinh} chọn hai đáp án đúng, hệ thống sẽ đánh dấu câu hỏi đó là mơ hồ, còn nếu tác tử không lựa chọn phương án nào thì câu hỏi sẽ được đánh dấu là không có đáp án đúng. Hay nói cách khác, câu hỏi được xác nhận đạt chuẩn khi và chỉ khi tác tử lựa chọn đúng một phương án duy nhất trùng với đáp án đã sinh từ vòng lặp trước.
...
Tác tử \textit{Hiệu chỉnh} có nhiệm vụ tiếp nhận và sửa lỗi các câu hỏi lỗi mà tác tử \textit{Học sinh} trả lời sai. Tác tử này sẽ được thiết kế để chỉ được phép chỉnh sửa nội dung của phần lựa chọn mà không được chỉnh sửa phần thân câu hỏi, trong khi bắt buộc giữ nguyên phần thân câu hỏi và cấp độ nhận thức.
