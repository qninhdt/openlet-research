...
Hình~\ref{fig:group_comparison} trình bày biểu đồ so sánh Acceptance trung bình của ba nhóm mô hình theo từng cấp độ nhận thức, qua đó cho thấy khác biệt về năng lực.
